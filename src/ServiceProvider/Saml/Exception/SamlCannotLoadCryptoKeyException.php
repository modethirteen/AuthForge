...
class SamlCannotLoadCryptoKeyException extends SamlCryptoKeyException {
    ...
    public function __construct(CryptoKeyInterface $key, string $error) {
        parent::__construct('Could not load {{Format}} with fingerprint: {{Fingerprint}}, {{Error}}', $key, $error);
    }
}
