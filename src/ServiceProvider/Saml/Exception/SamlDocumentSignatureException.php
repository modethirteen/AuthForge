...
class SamlDocumentSignatureException extends SamlCryptoKeyException {
    ...
    public function __construct(CryptoKeyInterface $key, string $error) {
        parent::__construct('Document cannot be signed by {{Format}} with fingerprint {{Fingerprint}}, {{Error}}', $key, $error);
    }
}
