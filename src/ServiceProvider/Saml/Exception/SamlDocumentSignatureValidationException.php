...
class SamlDocumentSignatureValidationException extends SamlCryptoKeyException {
    ...
    */
    public function __construct(CryptoKeyInterface $key, string $error) {
        parent::__construct('Document signature cannot be validated by {{Format}} with fingerprint {{Fingerprint}}, {{Error}}', $key, $error);
    }
}